...
| **Renomear**<br>*(Rename)* | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Edite os nomes dos seus macros facilmente.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Easily edit your macro names. |
...
| **Isolamento de Abas**<br>*(Tab Isolation)* | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Abas ativas desabilitam funcionalidades de outras abas para evitar conflitos.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Active tabs disable other tab functionalities to avoid conflicts. |
...
| :--- | :--- |
| **`+ Mouse`** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Simula cliques, duplos cliques e operações de arrastar & soltar.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Simulate clicks, double clicks, and drag & drop operations. |
| **`+ Keys`** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Simula digitação de texto e atalhos de teclado.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Simulate keyboard typing and shortcuts. |
| **`+ Mouse (Wait for Image)` <span style="color: red;"><br>(opencv / Spectacle)</span>** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Busca na tela pelo objeto semelhante ao das imagens adicionadas e simula cliques, duplos cliques e operações de arrastar & soltar em cima do objeto detectado.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> The screen searches for objects similar to those in the added images and simulates clicks, double-clicks, and drag-and-drop operations on top of the detected object. |
| **`+ Keys (Wait for Image)` <span style="color: red;"><br>(opencv / Spectacle)</span>** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Busca na tela pelo objeto semelhante ao das imagens adicionadas e simula digitação de texto e atalhos de teclado em cima do objeto detectado.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> The screen searches for objects similar to those in the added images and simulates typing text and using keyboard shortcuts on top of the detected object. |
...
| **Hotkeys** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Atribua teclas F1-F12 para iniciar, parar e selecionar janelas alvo.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Assign specific F1-F12 keys for starting, stopping, and picking target windows. |
...
| **Hotkeys** | <img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/01.svg" width="16"/> Atribua teclas F1-F12 para iniciar/parar gravação e reprodução.<br><img src="https://codeberg.org/oGiu/.profile/raw/branch/main/images/02.svg" width="16"/> Assign specific F1-F12 keys to easily start/stop recording and playback. |
